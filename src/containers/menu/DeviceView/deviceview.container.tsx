...
let data;
export class DeviceViewContainer extends React.Component<
...
> {
  ...
  widgetDisplay = () => {
    if (this.state.widgetLayout) {
      return this.state.widgetLayout.map((widget, i) => {
        const deviceprops = {
      ...
      return (
        <View>
          <Text style={{ color: theme.color }}>No widgets to display.....</Text>
        </View>
      );
    }
  };
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        ></TopNavigation>
        <ScrollView
          style={{ backgroundColor: theme.backgroundColor, padding: 8 }}
        >
          <ScrollView>
            <ScrollView
              style={{ backgroundColor: '#202020', paddingBottom: 5 }}
            >
